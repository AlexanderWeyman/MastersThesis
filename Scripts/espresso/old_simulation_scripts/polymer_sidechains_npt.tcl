...
# create rdf, distribution and formfactor all data files if flag is set and if files do not exist ############################################################
...
if { $calculateIntegratedCIDistribution && $write_all_distr_values } {
    ...
    puts $analyze_output_all_intCIdistr_data_file -nonewline "[setmd time]\tx\t"
    foreach value [lindex $distr 1] {
        puts $analyze_output_all_intCIdistr_data_file -nonewline "[lindex $value 0]"
